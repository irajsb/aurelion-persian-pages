  ...
  const games = [
    {
      ...
      genre: "ماجراجویی",
      status: "در حال توسعه",
      description: "پروژه‌های هیجان‌انگیز ما به زودی معرفی خواهند شد",
    },
    {
      title: "در دست اقدام",
      genre: "اکشن",
      status: "در حال بررسی",
      description: "در حال ارزیابی بازی‌های جدید برای انتشار",
    },
    {
      title: "پروژه محرمانه",
      genre: "نقش‌آفرینی",
      status: "طراحی",
      description: "یک تجربه منحصر به فرد در راه است",
    },
  ];
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            مجموعه‌ای از تجربه‌های بی‌نظیر گیمینگ
          </p>
        </div>
