...
const About = () => {
  const features = [
    ...
    },
    {
      ...
      description: "پشتیبانی کامل از استودیوهای مستقل و توسعه‌دهندگان مستعد",
    },
    {
      icon: Trophy,
      title: "موفقیت مشترک",
      description: "هدف ما موفقیت مشترک با شرکای خلاق خود است",
    },
  ];
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            ما یک شرکت ناشر بازی هستیم که به ارائه بهترین تجربه‌های گیمینگ به بازیکنان در سراسر جهان متعهد است
          </p>
        </div>
